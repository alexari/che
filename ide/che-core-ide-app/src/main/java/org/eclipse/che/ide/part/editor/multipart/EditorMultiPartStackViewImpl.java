        ...
        partViewContainer = new AcceptsOneWidget() {
            ...
            public void setWidget(IsWidget widget) {
                if (constraints == null) {
                    ...
                    splitEditorParts.put(partStack, parentContainer);
                    contentPanel.add(parentContainer);
                    return;
                }

                SplitEditorPartView targetContainer = splitEditorParts.get(specimenPartStack);
                ...
                parentContainer = new SplitLayoutPanel(5);
                parentContainer.ensureDebugId("editor-splitlayout-panel");

                SimpleLayoutPanel specimenContainer = new SimpleLayoutPanel();
                specimenContainer.ensureDebugId("editor-specimenContainer");

                SimpleLayoutPanel replicaContainer = new SimpleLayoutPanel();
                replicaContainer.ensureDebugId("editor-replicaContainer");

                Widget specimen = targetContainer.getWidget();
                specimenContainer.add(specimen);
                splitEditorParts.put(specimenPartStack, specimenContainer);

                replicaContainer.add(widget);
                splitEditorParts.put(partStack, replicaContainer);
